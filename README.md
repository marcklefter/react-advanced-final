...
See [this article](https://web.dev/virtualize-long-lists-react-window/) for getting started with more efficient list rendering.
...
*   [Jest](https://jestjs.io/docs/en/getting-started)
    ...
    Running your unit tests with the Jest test runner 
    
    > Note: Jest is automatically included and configured in any project generated by _create-react-app_; just create your `*.spec.js` files and run them via `npm test`.
